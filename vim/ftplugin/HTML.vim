...
" ---- Template Toolkit: ------------------------------------------------ {{{1
"       Template Toolkit-style variable name
call HTMLmap("nnoremap", ";tv", "lbi[% <ESC>ea %]<ESC>")
call HTMLmap("inoremap", ";Tt", "[%  %]<ESC>F\"")
call HTMLmap("vnoremap", ";Tt", "<ESC>`>a %]<C-O>`<[% <C-O>F\"<ESC>")
...
call HTMLmap("vnoremap", ";cm", "<ESC>`>a --><C-O>`<<!-- <ESC>")
...
call HTMLmap("vnoremap", ";ad", "<ESC>`>a</address><C-O>`<<address><ESC>")

"       B       Boldfaced Text          HTML 2.0
call HTMLmap("inoremap", ";bo", "<b></b><ESC>hhhi")
call HTMLmap("vnoremap", ";bo", "<ESC>`>a</b><C-O>`<<b><ESC>")

"       BASE                            HTML 2.0        HEADER
call HTMLmap("inoremap", ";bh", "<base href=\"\"><ESC>hi")
call HTMLmap("vnoremap", ";bh", "<ESC>`>a\"><C-O>`<<base href=\"<ESC>")
...
call HTMLmap("vnoremap", ";ce", "<ESC>`>a</center><C-O>`<<center><ESC>")

"       CITE                            HTML 2.0
call HTMLmap("inoremap", ";ci", "<cite></cite><ESC>bhhi")
call HTMLmap("vnoremap", ";ci", "<ESC>`>a</cite><C-O>`<<cite><ESC>")

"       CODE                            HTML 2.0
call HTMLmap("inoremap", ";co", "<code></code><ESC>bhhi")
call HTMLmap("vnoremap", ";co", "<ESC>`>a</code><C-O>`<<code><ESC>")
...
call HTMLmap("inoremap", ";dt", "<dt></dt>")
call HTMLmap("vnoremap", ";dt", "<ESC>`>a</dt><C-O>`<<dt><ESC>")
call HTMLmap("inoremap", ";dd", "<dd></dd>")
call HTMLmap("vnoremap", ";dd", "<ESC>`>a</dd><C-O>`<<dd><ESC>")
...
call HTMLmap("vnoremap", ";df", "<ESC>`>a</dfn><C-O>`<<dfn><ESC>")
...
call HTMLmap("vnoremap", ";sn", "<ESC>`>a</span><C-O>`<<span><ESC>")

"       EM      Emphasize               HTML 2.0
call HTMLmap("inoremap", ";em", "<em></em><ESC>bhhi")
call HTMLmap("vnoremap", ";em", "<ESC>`>a</em><C-O>`<<em><ESC>")
...
call HTMLmap("vnoremap", ";h1", "<ESC>`>a</h1><C-O>`<<h1><ESC>")
call HTMLmap("vnoremap", ";h2", "<ESC>`>a</h2><C-O>`<<h2><ESC>")
call HTMLmap("vnoremap", ";h3", "<ESC>`>a</h3><C-O>`<<h3><ESC>")
call HTMLmap("vnoremap", ";h4", "<ESC>`>a</h4><C-O>`<<h4><ESC>")
call HTMLmap("vnoremap", ";h5", "<ESC>`>a</h5><C-O>`<<h5><ESC>")
call HTMLmap("vnoremap", ";h6", "<ESC>`>a</h6><C-O>`<<h6><ESC>")
...
call HTMLmap("vnoremap", ";it", "<ESC>`>a</i><C-O>`<<i><ESC>")
...
"       INCLUDE
call HTMLmap("inoremap", ";inc", "<!--#include virtual=\"\" --><ESC>bhhi")
call HTMLmap("vnoremap", ";inc", "<ESC>`>a\" --><C-O>`<<lt>!--#include virtual=\"<ESC>")
...
call HTMLmap("vnoremap", ";kb", "<ESC>`>a</kbd><C-O>`<<kbd><ESC>")

"       LEGEND
call HTMLmap("inoremap", ";le", "<legend></legend><ESC>bhhi")
call HTMLmap("vnoremap", ";le", "<ESC>`>a</legend><C-O>`<<legend><ESC>")

"       LI      List Item               HTML 2.0
call HTMLmap("inoremap", ";li", "<li></li><ESC>bhhi")
call HTMLmap("vnoremap", ";li", "<ESC>`>a</li><C-O>`<<li><ESC>")
...
call HTMLmap("vnoremap", ";lh", "<ESC>`>a</lh><C-O>`<<lh><ESC>")
...
call HTMLmap("inoremap", ";pp", "<p></p><ESC>bhhi")
call HTMLmap("vnoremap", ";pp", "<ESC>`>a</p><C-O>`<<p><ESC>")
" visual paragraph
call HTMLmap("inoremap", ";pv", "<ESC>V<ESC>`>a</p><C-O>`<<p><ESC>")
call HTMLmap("vnoremap", ";pv", "<ESC>`>a</p><C-O>`<<p><ESC>")

"       PRE     Preformatted Text       HTML 2.0
call HTMLmap("inoremap", ";pr", "<pre><CR></pre><ESC>O")
call HTMLmap("vnoremap", ";pr", "<ESC>`>a<CR><ESC>i</pre><C-O>`<<pre><CR><ESC>")
...
call HTMLmap("vnoremap", ";sk", "<ESC>`>a</strike><C-O>`<<strike><ESC>")

"       SAMP    Sample Text             HTML 2.0
call HTMLmap("inoremap", ";sa", "<samp></samp><ESC>bhhi")
call HTMLmap("vnoremap", ";sa", "<ESC>`>a</samp><C-O>`<<samp><ESC>")
...
call HTMLmap("vnoremap", ";ls", "<ESC>`>a\"><C-O>`<<link rel=\"stylesheet\" type=\"text/css\" href=\"<ESC>")

"       SUB     Subscript               HTML 3.0
call HTMLmap("inoremap", ";sb", "<sub></sub><ESC>bhhi")
call HTMLmap("vnoremap", ";sb", "<ESC>`>a</sub><C-O>`<<sub><ESC>")

"       SUP     Superscript             HTML 3.0
call HTMLmap("inoremap", ";sp", "<sup></sup><ESC>bhhi")
call HTMLmap("vnoremap", ";sp", "<ESC>`>a</sup><C-O>`<<sup><ESC>")
...
call HTMLmap("vnoremap", ";va", "<ESC>`>a</var><C-O>`<<var><ESC>")
...
call HTMLmap("vnoremap", ";th", "<ESC>`>a</th><C-O>`<<th><ESC>")
